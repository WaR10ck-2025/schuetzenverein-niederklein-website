  ...
  return (
    <div>
      ...
      <Section title="3. Datenerfassung auf dieser Website">
        ...
        <Text>
          Wenn Sie uns über das Kontaktformular eine Nachricht senden, wird diese über den Dienst
          Web3Forms verarbeitet. Die dabei übertragenen Daten (Name, E-Mail-Adresse, Nachrichteninhalt)
      ...
      <Section title="4. Externe Links und Dienste">
        <Text>
          Diese Website enthält Links zu externen Diensten (Google Maps). Beim Aufrufen dieser Dienste
          können deren Betreiber Daten erheben. Bitte beachten Sie die jeweiligen Datenschutzerklärungen
          dieser Anbieter.
        </Text>
      </Section>
